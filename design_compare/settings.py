"""
Django settings for design_compare project.
...
SECRET_KEY = '&y=o!**8e)z%5^2bymt*2d-4b+y1qb0t5wur8i9g_z!^&-2hex'
...
ROOT_URLCONF = 'design_compare.urls'
...
# WSGI_APPLICATION = 'design_compare.wsgi.application'
...
CSRF_TRUSTED_ORIGINS = ["http://10.1.75.152/"]
...
MESSAGE_TAGS = {
    messages.DEBUG: 'alert alert-debug alert-dismissible fade show',
